...
PROMPT_VERSION = "decision/v3.2.0"
...
2. ФИНАНСОВЫЙ РАЗРЕЗ — услуги из чеков (doc_source начинается на 'receipt_'):
   ...
   - БАД / Витаминные добавки при отсутствии профильного дефицита в диагнозах
   НЕ ФЛАГИРОВАТЬ (стандартно обоснованные):
   - Консультация врача — обоснована при любом диагнозе
   - Анализ крови / ОАК / Биохимия — обоснованы при большинстве диагнозов
   - ЭКГ — обосновано при кардиологических диагнозах (I10, I25, I48, и др.)
   - Узи / Рентген — обоснованы если орган соответствует диагнозу

Несоответствие в ЛЮБОМ разрезе → опиши конкретно в coherence_flags и снизь confidence.
